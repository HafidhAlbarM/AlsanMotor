            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <!-- <a href="<?php echo base_url() ?>pemesanan/https://wrappixel.com/templates/ampleadmin/" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var dataTable=$("#table_product").DataTable({
                ...
                "iDisplayLength":5,
                "ajax":{
                    url:"<?php echo base_url('C_transaksipemesanan/ambil_data_pemesanan') ?>",
                    method:"POST"
                },
                "columnDefs":[
                 {
