            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h3 class="page-title">Selling Report <i class="fa fa-file-text-o fa-fw" aria-hidden="true"></i></h3> </div>
                            ...
                            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                     <form method="POST" action="<?php echo base_url('C_transaksipenjualan/generate_report_penjualan') ?>">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="col-sm-9">
                                                    ...
                                                    ?>  
                                                        <br>
                                                        <a href="<?php echo base_url('C_transaksipenjualan/export_to_pdf')?>" class="btn btn-danger" target="_blank" title="Export To PDF"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
