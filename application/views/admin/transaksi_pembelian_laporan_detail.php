...
<head>
    ...
    <title>Alsan Motor | Purchasing Report</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h3 class="page-title">Purchasing Report Detail <i class="fa fa-file-text-o fa-fw" aria-hidden="true"></i></h3> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <!-- <a href="https://wrappixel.com/templates/ampleadmin/" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a> -->
                        <ol class="breadcrumb">
                            <li><a href="<?php echo base_url('c_main/admin_index') ?>">Dashboard</a></li>
                            <li class="active">Purchasing Report</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                     <form method="POST" action="<?php echo base_url('C_transaksipembelian/generate_report_pembelian_detail') ?>">
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    ?>
                                                        <br>
                                                        <a href="<?php echo base_url('C_transaksipembelian/export_to_pdf_detail')?>" class="btn btn-danger" target="_blank" title="Export To PDF"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
